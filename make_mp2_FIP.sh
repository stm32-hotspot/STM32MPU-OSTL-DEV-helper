...
function do_build_uboot() {
  ...
  for dt in "stm32mp257f-dk" ${CUSTOM_DTS_NAME}; do
     make -f ../Makefile.sdk.${STM32MP_PLATFORM} UBOOT_CONFIG=${BOOT_DEVICE} DEVICE_TREE=${dt} \
...
mv ${SDK_HELPER_OUTPUT}/FLASH_LAYOUT/${STM32MP_PLATFORM}/flash.sh  ${SDK_HELPER_OUTPUT}/
chmod 755 ${SDK_HELPER_OUTPUT}/flash.sh
mv ${SDK_HELPER_OUTPUT}/FLASH_LAYOUT/${STM32MP_PLATFORM}/flash.bat ${SDK_HELPER_OUTPUT}/
